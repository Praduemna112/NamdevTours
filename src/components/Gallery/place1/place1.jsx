...
import placeImg1 from "../../../assets/Gallery/gallery/mumbai/image1.jpg";
import placeImg2 from "../../../assets/Gallery/gallery/mumbai/image1.jpg";
import placeImg3 from "../../../assets/Gallery/gallery/mumbai/image1.jpg";
    ...
    >
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-white">Mumbai</h1>
